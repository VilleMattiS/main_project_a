...
main_project_a <- intermediate_project_ak <- subject_folder <- material_folder <- codefiles for assigments & practice problems, and working through chapter material or lecture material(Like examples of the concepts coded from lecture material)
